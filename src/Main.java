public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("медик hp-" + medic.getHealth() + " sposobnost-" + medic.getPower() + " uron-" + medic.getDamage());
        System.out.println("hp-" + warrior.getHealth() + " uron-" + warrior.getDamage() + " sposobnost-" + warrior.getPower());
        System.out.println("hp-" + magic.getHealth() + " damage-" + magic.getDamage() + " power-" + magic.getPower());
